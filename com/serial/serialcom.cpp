...
serialCom::serialCom(QWidget *parent) : QWidget(parent),
                                        ui(new Ui::serialCom)
{
    ui->setupUi(this);
    this->initMycom();
...
void serialCom::initMycom()
{
    ...
    ui->baudRateComboBox->addItems(QStringList() << "1200"
                                                 << "2400"
                                                 << "4800"
                                                 << "9600"
                                                 << "19200"
                                                 ...
                                                 << "57600"
                                                 << "115200");
    ui->dataBitsComboBox->addItems(QStringList() << "5"
                                                 << "6"
                                                 << "7"
                                                 << "8");
    ui->parityComboBox->addItems(QStringList() << "奇"
                                               << "偶"
                                               << "无");
    ui->stopBitsComboBox->addItems(QStringList() << "1"
                                                 << "1.5"
                                                 << "2");
    ui->flowComboBox->addItems(QStringList() << "无"
                                             << "硬件"
                                             << "软件");
}
